            ...
            <Flex flexDirection={['column-reverse', 'row']}>
              <Box mr={[0, 4]} width={[1, 1 / 2]}>
                {! readToggle && (
                  <Box>
                    <p>
                      We need #HomesForAll to #FlattenTheCurve. That's why we're putting pressure on our decision-makers at
                      every level to enact our people’s plan to ensure a healthy, stable, thriving future for us all.
                    </p>
                    <p>
                      Use this tool to send a message directly to your representatives, urging them to commit to the following
                      campaign demands &mdash;
                    </p>

                    <Button fontSize={1} onClick={() => setReadToggle(true)}>Read more</Button>
                  </Box>
                )}
                ...
                <Box style={{ opacity: readToggle ? 1 : 0, transition: 'opacity 0.3s ease-in-out'}}>
                  ...
                  <p>
                    Cancel all rent, mortgage and utility payments and ensure no person or small business takes on new debt
                    during this crisis.
                  </p>
                  ...
                  <ul>
                    <li>
                      Halt evictions, foreclosures, raids and sweets and to turn vacant units into safe homes & refuge for
                      people experiencing homelessness
                    </li>
                    <li>
                      Ensure the well-being of those incarcerated or detained and the general public by releasing our people
                      from cages.
                    </li>
                  </ul>
                  ...
                  <p>
                    Prohibit all utilities shut offs, rate increases and restore essential services to all households. We
                    must guarantee water, electricity, gas, phone and internet essential to our health and well-being.
                  </p>

                  <h2>We want a future where our work is valued and protected.</h2>
                  <p>
                    The COVID-19 crisis is showing clearly who the most essential workers are in our world - and it’s not
                    the CEOs and the 1%. It’s the teachers, the warehouse workers, the nurses, the domestic workers, the
                    home health aides and service workers.
                  </p>
                  <p>
                    We must guarantee unemployment, sick-time and paid leave, health care, worker protections and a
                    living-wage for all.
                  </p>

                  <p>
                    If you have time, share your own story about how this is affecting your life [in the first paragraph].
                    Together we can flood the inboxes of our representatives with powerful testimonies that demonstrate why
                    we need to go #BeyondRecovery and guarantee #HomesForAll!
                  </p>
                </Box>
              </Box>
