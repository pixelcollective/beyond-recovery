    ...
    <div id="main" className="alt">
      <section id="one">
        <div className="inner">
          ...
          <p>
            With the coronavirus crisis, many of us are stuck between staying healthy or staying housed. With the loss
            of our incomes, we may not be able to make rent on April 1st or May 1st.  We’re envisioning a future beyond
            recovery and calling out to our electeds to #CancelRent #CancelMortgages and guarantee #HomesForAll!
          </p>
          <p>
