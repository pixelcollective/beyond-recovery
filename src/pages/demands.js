    ...
    <Container>
      <Header>
        <Grid>
          <Col size="12">
            ...
            <PageSubTitle>A people’s plan to ensure a healthy, stable, thriving future for us all.</PageSubTitle>
          </Col>
        </Grid>
        <Grid>
          <Col size="6">
      ...
      <Grid>
        ...
        <Col size="6">
          ...
          <SubDemand>Immediately Cancel Rent, Mortgage and Utility Payments, No New Debts.</SubDemand>
          <p>
      ...
      <Grid
        ...
        `}>
        <Col size="12">
          <Demand>We want a future with safe, dignified and cage-free shelter, sanctuary and homes for all.</Demand>
          <SubDemand>
      ...
      <Grid>
        <Col size="12">
          <SubDemand>Permanent Refuge and Moratorium on Evictions, Foreclosures, Raids, Sweeps</SubDemand>
