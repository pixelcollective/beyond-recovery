        ...
        <Flex backgroundColor={'#0082F2'} flexDirection={['column', 'column', 'row']} flexWrap={true}>
          <Box>
            <div style={{position :'relative', marginBottom: '2rem'}}>
              <Image fluid={data.image01.childImageSharp.fluid} style={{border: '1px solid rgba(255, 255, 255, 0.4)', minWidth: '100%', width: '64rem', height: '32rem', objectFit: 'cover'}} />
              <div style={{background: 'rgba(0, 0, 0, 0.4)', width: '100vw', height: '100%', position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, ['&::hover']: { background: 'rgba(0, 0, 0, 0)'}}}></div>
          ...
          <Box>
          <div style={{position :'relative', marginBottom: '2rem'}}>
            <Image fluid={data.image06.childImageSharp.fluid} style={{border: '1px solid rgba(255, 255, 255, 0.4)', minWidth: '100%', width: '64rem', height: '32rem', objectFit: 'cover'}} />
            <div style={{background: 'rgba(0, 0, 0, 0.4)', width: '100vw', height: '100%', position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, ['&::hover']: { background: 'rgba(0, 0, 0, 0)'}}}></div>
            <div style={{position: 'absolute', top: 0, left: 0, right: 0, padding: '2rem'}}>
              <div className="inner">
                <header className="major">
